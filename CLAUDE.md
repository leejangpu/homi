...
| Gmail 안읽음 정리 (기계성 읽음처리 + 중요건 요약 알림) | 09:10 | `financial/gmail_triage.py` | `com.homi.gmail-triage.plist` | ✅ 운영중 |
