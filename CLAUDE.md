...
| 떨사오팔(n분할 매수) | `ddsaopal/src/main-{open,close}.ts`, `calculator.ts`, `tossApi.ts` | `ddsaopal/SPEC.md`, `ddsaopal/README.md` |
...
| `ddsaopal/SPEC.md` (+ `ddsaopal/README.md`) | **떨사오팔 권위 사양** (n분할/전일종가 LOC 매수/+0.3% 매도/12일 손절/사이클, 토스 MOC 미지원→저가 LOC) | ✅ 최신, 떨사오팔 진실원 |
